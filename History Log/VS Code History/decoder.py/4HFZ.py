...
cache = {'functionCalls':{}, 'arrayCalls':{}, 'evalCalls':{}, 'procedureCalls':{}}
cacheState = False
    ...
    #split it to variables / values
        if cacheState and value in cache["evalCalls"].keys():
            ...
            if cacheState:
                ...
                cache["evalCalls"][value]["concat"] = concat
                cache["evalCalls"][value]["ignoreTypeChecks"] = ignoreTypeChecks
                cache["evalCalls"][value]["valList"] = valList.copy()
                cache["evalCalls"][value]["oldValList"] = oldValList.copy()
