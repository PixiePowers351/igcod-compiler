...
- *Compiling / reverse compiling:* I will be adding a setting to convert pseudocode into another commonly used beginner language, such as C, C++, javascript, java, or bash, or python and a setting to convert a program of any of the aforementioned types to a 
