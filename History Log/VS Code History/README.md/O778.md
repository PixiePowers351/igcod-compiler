...
1. *Install Python if it is not present in your computer.* The version I have on my machine is python 3.11 available to download [here](). Other versions of python could work, but I haven't tested it out yet.
