...
- *Libraries for operations:* This includes things like GUI handling, color customisations in the terminal, sound handling, json handling, some typical library functions such as .split and .replace 
---
