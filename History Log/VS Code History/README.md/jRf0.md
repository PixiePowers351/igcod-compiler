...
## Images
Execution of a simple Hello World program
![Execution of a simple Hello World program](image-3.png)

Execution for medium length programs in an IGCSE compiler: A denary to binary converter
![Execution for medium length programs in an IGCSE compiler](image.png)

Execution of a random number game - this is the typical execution speed for a longer, resource intensive program
![Execution of a random number game - this is the typical execution speed for a longer, resource intensive program](image-2.png)
...
- *Commenting:* I know there's very few comments. Im sorry (ToT) I'll keep adding them, maybe a few days later, so dont worry about that! I'm sorry for anyone who has to read my atrocious code, especially since the logic isn't even standard 99% of the time - most of them were just shower thought logics - I don't really copy code from anywhere, so ... yeah. It's not.. hard. Most logic is easy enough for anyone to understand, but the syntax IS going to be hard to look at. Don't worry, I'll add comments to explain my code!
