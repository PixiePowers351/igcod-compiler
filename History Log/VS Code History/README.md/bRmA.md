...
4. Write the code using official pseudocode syntax, as in the [IGCSE Computer Science syllabus of 2023 - 2028](https://www.cambridgeinternational.org/Images/697167-2026-2028-syllabus.pdf#page=35)

5. *Once you're done, check settings.json to ensure the settings are as required for your program:*
