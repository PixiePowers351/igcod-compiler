...
def getVal(value):
    ...
    #check if real
    elif "." in value and value.split(".") == 2 and value.split(".")[0].isnumeric() and value.split(".")[1].isnumeric():
        value = float(value)
    ...
    elif (True in [len(bracketExcludedSplit(value,m))>1 for m in operators['all']]) or value[:4]=="NOT " or value[:5]==" NOT(":
